...
/**
 * An object to store a value published on the source <code>programs</code> of the device <code>TvGuide</code>.
 *
 * <pre>
...
public final class ProgramsFromTvGuide implements Serializable {
    ...
    /**
     * Get the value of the source <code>programs</code>
     * 
    ...
    /**
     * Get the value of the indices of the source <code>programs</code>
     * 
    ...
    public ProgramsFromTvGuide(Service service, RemoteServiceInfo remoteServiceInfo, java.util.List<fr.inria.phoenix.diasuite.framework.datatype.tvschedule.TvSchedule> value,
    ...
    /**
     * Get the sender of the source <code>programs</code>. I.e., the <code>TvGuide</code> device that published the source.
     * 
    ...
    public class TvGuideProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>programs</code> from this <code>TvGuide</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>programs</code> from this <code>TvGuide</code>.
         */
