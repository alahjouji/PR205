...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>OverflowSensor</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromOverflowSensor implements Serializable {
    ...
    public IsAliveFromOverflowSensor(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromOverflowSensor other = (IsAliveFromOverflowSensor) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>OverflowSensor</code> device that published the source.
     * 
    ...
    public class OverflowSensorProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>OverflowSensor</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>OverflowSensor</code>.
         */
