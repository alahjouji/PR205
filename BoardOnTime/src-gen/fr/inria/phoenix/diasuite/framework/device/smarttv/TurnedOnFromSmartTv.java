...
/**
 * An object to store a value published on the source <code>turnedOn</code> of the device <code>SmartTv</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class TurnedOnFromSmartTv implements Serializable {
    ...
    public TurnedOnFromSmartTv(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TurnedOnFromSmartTv other = (TurnedOnFromSmartTv) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>turnedOn</code>. I.e., the <code>SmartTv</code> device that published the source.
     * 
    ...
    public class SmartTvProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>turnedOn</code> from this <code>SmartTv</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>turnedOn</code> from this <code>SmartTv</code>.
         */
