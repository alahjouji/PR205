 ...
 */
public abstract class AbstractBattery extends Service {
    
    public AbstractBattery(ServiceConfiguration serviceConfiguration,
            java.lang.String idValue,
            java.lang.String locationValue,
            java.lang.String userValue) {
        super("/Device/Device/PhysicalDevice/Battery/", serviceConfiguration);
        updateId(idValue);
    ...
    public Object getValueCalled(java.util.Map<String, Object> properties, RemoteServiceInfo source, String orderName, Object... args) throws Exception {
        ...
        if (orderName.equals("batteryState")) {
    ...
    private java.lang.Integer _batteryState;
     ...
     */
    protected void publishBatteryState(java.lang.Integer newBatteryStateValue) {
        _batteryState = newBatteryStateValue;
        getProcessor().publishValue(getOutProperties(), "batteryState", newBatteryStateValue); 
    }
    
    /**
     * Returns the value of source <code>batteryState</code> from device <code>Battery</code>.
