...
public abstract class AbstractVisualNotifier extends Service {
    ...
    public AbstractVisualNotifier(ServiceConfiguration serviceConfiguration,
    ...
    /**
     * Implement this method to define the <code>notify</code> order from the <code>Notification</code> action
