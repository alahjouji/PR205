...
/**
 * An object to store a value published on the source <code>status</code> of the device <code>Cooker</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class StatusFromCooker implements Serializable {
    ...
    public StatusFromCooker(Service service, RemoteServiceInfo remoteServiceInfo, fr.inria.phoenix.diasuite.framework.datatype.state.State value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        StatusFromCooker other = (StatusFromCooker) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>status</code>. I.e., the <code>Cooker</code> device that published the source.
     * 
    ...
    public class CookerProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>status</code> from this <code>Cooker</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>status</code> from this <code>Cooker</code>.
         */
