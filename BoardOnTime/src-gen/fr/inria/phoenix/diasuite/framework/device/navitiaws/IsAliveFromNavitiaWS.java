...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>NavitiaWS</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromNavitiaWS implements Serializable {
    ...
    public IsAliveFromNavitiaWS(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromNavitiaWS other = (IsAliveFromNavitiaWS) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>NavitiaWS</code> device that published the source.
     * 
    ...
    public class NavitiaWSProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>NavitiaWS</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>NavitiaWS</code>.
         */
