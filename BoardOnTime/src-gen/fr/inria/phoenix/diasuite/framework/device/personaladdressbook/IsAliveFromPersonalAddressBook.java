...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>PersonalAddressBook</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromPersonalAddressBook implements Serializable {
    ...
    public IsAliveFromPersonalAddressBook(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromPersonalAddressBook other = (IsAliveFromPersonalAddressBook) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>PersonalAddressBook</code> device that published the source.
     * 
    ...
    public class PersonalAddressBookProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>PersonalAddressBook</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>PersonalAddressBook</code>.
         */
