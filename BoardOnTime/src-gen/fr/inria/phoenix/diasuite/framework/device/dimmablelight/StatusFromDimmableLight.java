...
/**
 * An object to store a value published on the source <code>status</code> of the device <code>DimmableLight</code>.
 *
 * <pre>
...
public final class StatusFromDimmableLight implements Serializable {
    ...
    public StatusFromDimmableLight(Service service, RemoteServiceInfo remoteServiceInfo, fr.inria.phoenix.diasuite.framework.datatype.state.State value) {
    ...
    /**
     * Get the sender of the source <code>status</code>. I.e., the <code>DimmableLight</code> device that published the source.
     * 
    ...
    public class DimmableLightProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>status</code> from this <code>DimmableLight</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>status</code> from this <code>DimmableLight</code>.
         */
