...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>BordeauxMetropole</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromBordeauxMetropole implements Serializable {
    ...
    public IsAliveFromBordeauxMetropole(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromBordeauxMetropole other = (IsAliveFromBordeauxMetropole) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>BordeauxMetropole</code> device that published the source.
     * 
    ...
    public class BordeauxMetropoleProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>BordeauxMetropole</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>BordeauxMetropole</code>.
         */
