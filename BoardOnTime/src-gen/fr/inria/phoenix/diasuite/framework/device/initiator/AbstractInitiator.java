 ...
 */
public abstract class AbstractInitiator extends Service {
    
    public AbstractInitiator(ServiceConfiguration serviceConfiguration,
            java.lang.String idValue,
            java.lang.String locationValue,
            java.lang.String userValue) {
        super("/Device/Device/PhysicalDevice/Initiator/", serviceConfiguration);
        updateId(idValue);
    ...
    public Object getValueCalled(java.util.Map<String, Object> properties, RemoteServiceInfo source, String orderName, Object... args) throws Exception {
        ...
        if (orderName.equals("answer1")) {
            return getAnswer1();
        }
        if (orderName.equals("answer2")) {
            return getAnswer2();
        }
    ...
    private java.lang.String _answer1;
     ...
     */
    protected void publishAnswer1(java.lang.String newAnswer1Value) {
        _answer1 = newAnswer1Value;
        getProcessor().publishValue(getOutProperties(), "answer1", newAnswer1Value); 
    }
    
    /**
     * Returns the value of source <code>answer1</code> from device <code>Initiator</code>.
    ...
    private java.lang.String _answer2;
     ...
     */
    protected void publishAnswer2(java.lang.String newAnswer2Value) {
        _answer2 = newAnswer2Value;
        getProcessor().publishValue(getOutProperties(), "answer2", newAnswer2Value); 
    }
    
    /**
     * Returns the value of source <code>answer2</code> from device <code>Initiator</code>.
