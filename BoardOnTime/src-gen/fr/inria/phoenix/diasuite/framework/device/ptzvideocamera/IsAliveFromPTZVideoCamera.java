...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>PTZVideoCamera</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromPTZVideoCamera implements Serializable {
    ...
    public IsAliveFromPTZVideoCamera(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromPTZVideoCamera other = (IsAliveFromPTZVideoCamera) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>PTZVideoCamera</code> device that published the source.
     * 
    ...
    public class PTZVideoCameraProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>PTZVideoCamera</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>PTZVideoCamera</code>.
         */
