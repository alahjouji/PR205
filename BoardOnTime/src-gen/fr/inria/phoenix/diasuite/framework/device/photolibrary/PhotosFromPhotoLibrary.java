...
/**
 * An object to store a value published on the source <code>photos</code> of the device <code>PhotoLibrary</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class PhotosFromPhotoLibrary implements Serializable {
    ...
    public PhotosFromPhotoLibrary(Service service, RemoteServiceInfo remoteServiceInfo, java.util.List<fr.inria.phoenix.diasuite.framework.datatype.photo.Photo> value, PhotosIndices indices) {
        this.sender = new PhotoLibraryProxy(service, remoteServiceInfo);
        this.value = value;
        this.indices = indices;
    }
    
    public PhotosFromPhotoLibrary(Service service, RemoteServiceInfo remoteServiceInfo, java.util.List<fr.inria.phoenix.diasuite.framework.datatype.photo.Photo> value,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        PhotosFromPhotoLibrary other = (PhotosFromPhotoLibrary) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>photos</code>. I.e., the <code>PhotoLibrary</code> device that published the source.
     * 
    ...
    public class PhotoLibraryProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>photos</code> from this <code>PhotoLibrary</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>photos</code> from this <code>PhotoLibrary</code>.
         */
