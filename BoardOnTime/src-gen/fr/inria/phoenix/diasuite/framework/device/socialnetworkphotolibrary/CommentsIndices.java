...
/**
 * Container for the indices of the source <code>comments</code> from device <code>SocialNetworkPhotoLibrary</code>.

<pre>
source comments as Comment [] indexed by photoID as String;
</pre>
 */
public final class CommentsIndices implements Serializable {
    private static final long serialVersionUID = 0;
    
    public CommentsIndices(java.lang.String photoID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        CommentsIndices other = (CommentsIndices) obj;
        if (_photoID == null) {
