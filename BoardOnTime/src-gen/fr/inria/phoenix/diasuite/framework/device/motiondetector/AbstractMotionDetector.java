...
public abstract class AbstractMotionDetector extends Service {
    ...
    private fr.inria.phoenix.diasuite.framework.datatype.state.State _motion;
     ...
     */
    protected void publishMotion(fr.inria.phoenix.diasuite.framework.datatype.state.State newMotionValue) {
