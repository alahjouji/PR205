...
/**
 * An object to store a value published on the source <code>present</code> of the device <code>Identifier</code>.
 *
 * <pre>
...
public final class PresentFromIdentifier implements Serializable {
    ...
    public PresentFromIdentifier(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value,
            java.lang.String id) {
        this.sender = new IdentifierProxy(service, remoteServiceInfo);
        this.value = value;
    ...
    /**
     * Get the sender of the source <code>present</code>. I.e., the <code>Identifier</code> device that published the source.
     * 
    ...
    public class IdentifierProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>present</code> from this <code>Identifier</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>present</code> from this <code>Identifier</code>.
         */
