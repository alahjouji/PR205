...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>PhotoFrame</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromPhotoFrame implements Serializable {
    ...
    public IsAliveFromPhotoFrame(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromPhotoFrame other = (IsAliveFromPhotoFrame) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>PhotoFrame</code> device that published the source.
     * 
    ...
    public class PhotoFrameProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>PhotoFrame</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>PhotoFrame</code>.
         */
