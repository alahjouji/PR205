 ...
 */
public abstract class AbstractIntrusionDetector extends Service {
    
    public AbstractIntrusionDetector(ServiceConfiguration serviceConfiguration,
            java.lang.String idValue,
            java.lang.String locationValue,
            java.lang.String userValue) {
        super("/Device/Device/PhysicalDevice/IntrusionDetector/", serviceConfiguration);
        updateId(idValue);
    ...
    public Object getValueCalled(java.util.Map<String, Object> properties, RemoteServiceInfo source, String orderName, Object... args) throws Exception {
        ...
        if (orderName.equals("intrusionDetected")) {
            return getIntrusionDetected();
        }
    ...
    private java.lang.Boolean _intrusionDetected;
     ...
     */
    protected void publishIntrusionDetected(java.lang.Boolean newIntrusionDetectedValue) {
        _intrusionDetected = newIntrusionDetectedValue;
        getProcessor().publishValue(getOutProperties(), "intrusionDetected", newIntrusionDetectedValue); 
    }
    
    /**
     * Returns the value of source <code>intrusionDetected</code> from device <code>IntrusionDetector</code>.
