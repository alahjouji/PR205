...
/**
 * An object to store a value published on the source <code>image</code> of the device <code>VideoCamera</code>.
 *
 * <pre>
...
public final class ImageFromVideoCamera implements Serializable {
    ...
    /**
     * Get the sender of the source <code>image</code>. I.e., the <code>VideoCamera</code> device that published the source.
     * 
    ...
    public class VideoCameraProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>image</code> from this <code>VideoCamera</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>image</code> from this <code>VideoCamera</code>.
         */
