...
public abstract class AbstractContactSensor extends Service {
    ...
    private fr.inria.phoenix.diasuite.framework.datatype.state.State _state;
     ...
     */
    protected void publishState(fr.inria.phoenix.diasuite.framework.datatype.state.State newStateValue) {
        _state = newStateValue;
        getProcessor().publishValue(getOutProperties(), "state", newStateValue); 
    }
    
    /**
     * Returns the value of source <code>state</code> from device <code>ContactSensor</code>.
