...
public final class MotionDetectorMock {
    ...
    class Proxy extends AbstractMotionDetector {
        ...
        protected fr.inria.phoenix.diasuite.framework.datatype.state.State getMotion() throws Exception {
            fr.inria.phoenix.diasuite.framework.datatype.state.State result = __motion;
            if(result == null)
                return super.getMotion();
            return result;
        }
        
        public void _publishMotion(fr.inria.phoenix.diasuite.framework.datatype.state.State newMotionValue) {
    ...
    @return this for fluent interface
     */
    public MotionDetectorMock motion(fr.inria.phoenix.diasuite.framework.datatype.state.State newMotionValue) {
        proxy._publishMotion(newMotionValue);
        return this;
    }
    
    private fr.inria.phoenix.diasuite.framework.datatype.state.State __motion = null;
    /**
    ...
    @return this for fluent interface
     */
    public MotionDetectorMock setMotion(fr.inria.phoenix.diasuite.framework.datatype.state.State newMotionValue) {
