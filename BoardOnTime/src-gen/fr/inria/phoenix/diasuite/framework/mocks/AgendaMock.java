...
public final class AgendaMock {
    ...
    class Proxy extends AbstractAgenda {
        ...
        protected fr.inria.phoenix.diasuite.framework.datatype.agendaevent.AgendaEvent getCurrentEvent() throws Exception {
            fr.inria.phoenix.diasuite.framework.datatype.agendaevent.AgendaEvent result = __currentEvent;
            if(result == null)
                return super.getCurrentEvent();
            return result;
        }
        
        public void _publishCurrentEvent(fr.inria.phoenix.diasuite.framework.datatype.agendaevent.AgendaEvent newCurrentEventValue) {
            publishCurrentEvent(newCurrentEventValue);
        }
    ...
    // Code for source currentEvent from device Agenda
    /**
     * Publish the value of source <code>currentEvent</code> from device <code>Agenda</code>.
    
    <pre>
    source currentEvent as AgendaEvent;
    </pre>
    @param newCurrentEventValue the new value for the source <code>currentEvent</code>
    @return this for fluent interface
     */
    public AgendaMock currentEvent(fr.inria.phoenix.diasuite.framework.datatype.agendaevent.AgendaEvent newCurrentEventValue) {
        proxy._publishCurrentEvent(newCurrentEventValue);
        return this;
    }
    
    private fr.inria.phoenix.diasuite.framework.datatype.agendaevent.AgendaEvent __currentEvent = null;
    /**
     * Set the value (without publication) of source <code>currentEvent</code> from device <code>Agenda</code>.
    ...
    @return this for fluent interface
     */
    public AgendaMock setCurrentEvent(fr.inria.phoenix.diasuite.framework.datatype.agendaevent.AgendaEvent newCurrentEventValue) {
        __currentEvent = newCurrentEventValue;
        return this;
    }
    // End of code for source currentEvent from device Agenda
