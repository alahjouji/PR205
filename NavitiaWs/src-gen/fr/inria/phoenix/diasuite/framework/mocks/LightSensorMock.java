...
public final class LightSensorMock {
    ...
    // Code for source level from device LightSensor
    /**
     * Publish the value of source <code>level</code> from device <code>LightSensor</code>.
    ...
    @return this for fluent interface
     */
    public LightSensorMock level(java.lang.Float newLevelValue) {
    ...
    /**
     * Set the value (without publication) of source <code>level</code> from device <code>LightSensor</code>.
    ...
    @return this for fluent interface
     */
    public LightSensorMock setLevel(java.lang.Float newLevelValue) {
        __level = newLevelValue;
        return this;
    }
    // End of code for source level from device LightSensor
}
