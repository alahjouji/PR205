...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>WaterMeter</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromWaterMeter implements Serializable {
    ...
    public IsAliveFromWaterMeter(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>WaterMeter</code> device that published the source.
     * 
    ...
    public class WaterMeterProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>WaterMeter</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>WaterMeter</code>.
         */
