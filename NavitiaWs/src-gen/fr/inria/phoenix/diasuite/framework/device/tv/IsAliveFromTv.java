...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>Tv</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromTv implements Serializable {
    ...
    public IsAliveFromTv(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromTv other = (IsAliveFromTv) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>Tv</code> device that published the source.
     * 
    ...
    public class TvProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>Tv</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>Tv</code>.
         */
