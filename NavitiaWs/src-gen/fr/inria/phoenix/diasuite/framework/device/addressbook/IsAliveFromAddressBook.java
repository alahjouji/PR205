...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>AddressBook</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromAddressBook implements Serializable {
    ...
    public IsAliveFromAddressBook(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromAddressBook other = (IsAliveFromAddressBook) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>AddressBook</code> device that published the source.
     * 
    ...
    public class AddressBookProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>AddressBook</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>AddressBook</code>.
         */
