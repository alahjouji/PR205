...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>LocalStorage</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromLocalStorage implements Serializable {
    ...
    public IsAliveFromLocalStorage(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromLocalStorage other = (IsAliveFromLocalStorage) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>LocalStorage</code> device that published the source.
     * 
    ...
    public class LocalStorageProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>LocalStorage</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>LocalStorage</code>.
         */
