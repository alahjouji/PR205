...
public abstract class AbstractHeater extends Service {
    ...
    public AbstractHeater(ServiceConfiguration serviceConfiguration,
    ...
    private fr.inria.phoenix.diasuite.framework.datatype.onoff.OnOff _status;
     ...
     */
    protected void publishStatus(fr.inria.phoenix.diasuite.framework.datatype.onoff.OnOff newStatusValue) {
        _status = newStatusValue;
        getProcessor().publishValue(getOutProperties(), "status", newStatusValue); 
    }
    
    /**
     * Returns the value of source <code>status</code> from device <code>Heater</code>.
