...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>ScreenPrompter</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromScreenPrompter implements Serializable {
    ...
    public IsAliveFromScreenPrompter(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromScreenPrompter other = (IsAliveFromScreenPrompter) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>ScreenPrompter</code> device that published the source.
     * 
    ...
    public class ScreenPrompterProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>ScreenPrompter</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>ScreenPrompter</code>.
         */
