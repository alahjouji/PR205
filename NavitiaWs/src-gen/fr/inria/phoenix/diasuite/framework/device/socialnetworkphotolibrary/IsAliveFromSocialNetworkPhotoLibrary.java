...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>SocialNetworkPhotoLibrary</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromSocialNetworkPhotoLibrary implements Serializable {
    ...
    public IsAliveFromSocialNetworkPhotoLibrary(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromSocialNetworkPhotoLibrary other = (IsAliveFromSocialNetworkPhotoLibrary) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>SocialNetworkPhotoLibrary</code> device that published the source.
     * 
    ...
    public class SocialNetworkPhotoLibraryProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>SocialNetworkPhotoLibrary</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>SocialNetworkPhotoLibrary</code>.
         */
