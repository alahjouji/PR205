...
/**
 * An object to store a value published on the source <code>lastTrustedMessage</code> of the device <code>SMSSender</code>.
 *
 * <pre>
...
public final class LastTrustedMessageFromSMSSender implements Serializable {
    ...
    /**
     * Get the sender of the source <code>lastTrustedMessage</code>. I.e., the <code>SMSSender</code> device that published the source.
     * 
    ...
    public class SMSSenderProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>lastTrustedMessage</code> from this <code>SMSSender</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>lastTrustedMessage</code> from this <code>SMSSender</code>.
         */
