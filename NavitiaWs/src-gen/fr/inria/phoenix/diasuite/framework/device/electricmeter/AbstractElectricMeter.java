...
public abstract class AbstractElectricMeter extends Service {
    ...
    private fr.inria.phoenix.diasuite.framework.datatype.state.State _currentElectricConsumption;
     ...
     */
    protected void publishCurrentElectricConsumption(fr.inria.phoenix.diasuite.framework.datatype.state.State newCurrentElectricConsumptionValue) {
    ...
    /**
     * Returns the value of source <code>currentElectricConsumption</code> from device <code>ElectricMeter</code>.
