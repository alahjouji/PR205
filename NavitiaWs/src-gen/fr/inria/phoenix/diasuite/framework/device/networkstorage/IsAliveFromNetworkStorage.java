...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>NetworkStorage</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromNetworkStorage implements Serializable {
    ...
    public IsAliveFromNetworkStorage(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromNetworkStorage other = (IsAliveFromNetworkStorage) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>NetworkStorage</code> device that published the source.
     * 
    ...
    public class NetworkStorageProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>NetworkStorage</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>NetworkStorage</code>.
         */
