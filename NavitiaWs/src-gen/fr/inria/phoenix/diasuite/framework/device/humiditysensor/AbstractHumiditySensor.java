 ...
 */
public abstract class AbstractHumiditySensor extends Service {
    
    public AbstractHumiditySensor(ServiceConfiguration serviceConfiguration,
            java.lang.String idValue,
            java.lang.String locationValue,
            java.lang.String userValue) {
        super("/Device/Device/PhysicalDevice/Sensor/HumiditySensor/", serviceConfiguration);
        updateId(idValue);
     ...
     */
    protected void publishLevel(java.lang.Integer newLevelValue) {
        _level = newLevelValue;
        getProcessor().publishValue(getOutProperties(), "level", newLevelValue); 
    }
    
    /**
     * Returns the value of source <code>level</code> from device <code>HumiditySensor</code>.
