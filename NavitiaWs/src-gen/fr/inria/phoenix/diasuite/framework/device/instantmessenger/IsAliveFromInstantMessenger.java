...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>InstantMessenger</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromInstantMessenger implements Serializable {
    ...
    public IsAliveFromInstantMessenger(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromInstantMessenger other = (IsAliveFromInstantMessenger) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>InstantMessenger</code> device that published the source.
     * 
    ...
    public class InstantMessengerProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>InstantMessenger</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>InstantMessenger</code>.
         */
