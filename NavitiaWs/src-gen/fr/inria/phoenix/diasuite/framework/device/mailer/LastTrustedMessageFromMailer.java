...
/**
 * An object to store a value published on the source <code>lastTrustedMessage</code> of the device <code>Mailer</code>.
 *
 * <pre>
...
public final class LastTrustedMessageFromMailer implements Serializable {
    ...
    /**
     * Get the sender of the source <code>lastTrustedMessage</code>. I.e., the <code>Mailer</code> device that published the source.
     * 
    ...
    public class MailerProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>lastTrustedMessage</code> from this <code>Mailer</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>lastTrustedMessage</code> from this <code>Mailer</code>.
         */
