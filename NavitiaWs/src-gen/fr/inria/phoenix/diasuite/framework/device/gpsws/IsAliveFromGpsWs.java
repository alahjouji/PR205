...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>GpsWs</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromGpsWs implements Serializable {
    ...
    public IsAliveFromGpsWs(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromGpsWs other = (IsAliveFromGpsWs) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>GpsWs</code> device that published the source.
     * 
    ...
    public class GpsWsProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>GpsWs</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>GpsWs</code>.
         */
