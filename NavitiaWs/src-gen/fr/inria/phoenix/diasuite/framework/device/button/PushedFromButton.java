...
/**
 * An object to store a value published on the source <code>pushed</code> of the device <code>Button</code>.
 *
 * <pre>
...
public final class PushedFromButton implements Serializable {
    ...
    /**
     * Get the value of the source <code>pushed</code>
     * 
     * @return the value of the source <code>pushed</code>
     */
    ...
    /**
     * Get the sender of the source <code>pushed</code>. I.e., the <code>Button</code> device that published the source.
     * 
    ...
    public class ButtonProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>pushed</code> from this <code>Button</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>pushed</code> from this <code>Button</code>.
         */
