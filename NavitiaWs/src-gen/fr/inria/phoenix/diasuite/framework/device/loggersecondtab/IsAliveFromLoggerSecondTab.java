...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>LoggerSecondTab</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromLoggerSecondTab implements Serializable {
    ...
    public IsAliveFromLoggerSecondTab(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromLoggerSecondTab other = (IsAliveFromLoggerSecondTab) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>LoggerSecondTab</code> device that published the source.
     * 
    ...
    public class LoggerSecondTabProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>LoggerSecondTab</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>LoggerSecondTab</code>.
         */
