...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>VideoCamera</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromVideoCamera implements Serializable {
    ...
    public IsAliveFromVideoCamera(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromVideoCamera other = (IsAliveFromVideoCamera) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>VideoCamera</code> device that published the source.
     * 
    ...
    public class VideoCameraProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>VideoCamera</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>VideoCamera</code>.
         */
