...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>SmartTv</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromSmartTv implements Serializable {
    ...
    public IsAliveFromSmartTv(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromSmartTv other = (IsAliveFromSmartTv) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>SmartTv</code> device that published the source.
     * 
    ...
    public class SmartTvProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>SmartTv</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>SmartTv</code>.
         */
