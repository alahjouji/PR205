...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>Microphone</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromMicrophone implements Serializable {
    ...
    public IsAliveFromMicrophone(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromMicrophone other = (IsAliveFromMicrophone) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>Microphone</code> device that published the source.
     * 
    ...
    public class MicrophoneProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>Microphone</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>Microphone</code>.
         */
