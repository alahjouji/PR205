...
/**
 * An object to store a value published on the source <code>nextProgram</code> of the device <code>TvGuide</code>.
 *
 * <pre>
...
public final class NextProgramFromTvGuide implements Serializable {
    ...
    /**
     * Get the value of the source <code>nextProgram</code>
     * 
    ...
    /**
     * Get the value of the indices of the source <code>nextProgram</code>
     * 
    ...
    public NextProgramFromTvGuide(Service service, RemoteServiceInfo remoteServiceInfo, fr.inria.phoenix.diasuite.framework.datatype.tvschedule.TvSchedule value,
    ...
    /**
     * Get the sender of the source <code>nextProgram</code>. I.e., the <code>TvGuide</code> device that published the source.
     * 
    ...
    public class TvGuideProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>nextProgram</code> from this <code>TvGuide</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>nextProgram</code> from this <code>TvGuide</code>.
         */
