...
public abstract class AbstractApplianceDashBoard extends Service {
    ...
    public AbstractApplianceDashBoard(ServiceConfiguration serviceConfiguration,
    ...
    public final Object orderCalled(java.util.Map<String, Object> properties, RemoteServiceInfo source, String orderName, Object... args) throws Exception {
        if (orderName.equals("changeStatus")) {
            changeStatus((fr.inria.phoenix.diasuite.framework.datatype.appliancetype.ApplianceType) args[0],
                    (java.lang.Boolean) args[1]);
            return null;
        }
    ...
    /**
     * Implement this method to define the <code>changeStatus</code> order from the <code>ADBStatus</code> action
     * defined in device ApplianceDashBoard.
     * 
     ...
     */
    protected abstract void changeStatus(fr.inria.phoenix.diasuite.framework.datatype.appliancetype.ApplianceType appliance,
