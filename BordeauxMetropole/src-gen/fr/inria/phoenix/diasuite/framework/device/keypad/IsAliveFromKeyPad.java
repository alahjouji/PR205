...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>KeyPad</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromKeyPad implements Serializable {
    ...
    public IsAliveFromKeyPad(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromKeyPad other = (IsAliveFromKeyPad) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>KeyPad</code> device that published the source.
     * 
    ...
    public class KeyPadProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>KeyPad</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>KeyPad</code>.
         */
