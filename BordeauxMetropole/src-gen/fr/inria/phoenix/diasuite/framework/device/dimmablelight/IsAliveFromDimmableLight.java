...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>DimmableLight</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromDimmableLight implements Serializable {
    ...
    public IsAliveFromDimmableLight(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromDimmableLight other = (IsAliveFromDimmableLight) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>DimmableLight</code> device that published the source.
     * 
     * @return A proxy to the <code>DimmableLight</code> that triggered the source
     */
    ...
    /**
     * A proxy to a <code>DimmableLight</code> that discloses subscription/unsubscription methods.
     */
    public class DimmableLightProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>DimmableLight</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>DimmableLight</code>.
         */
