...
/**
 * An object to store a value published on the source <code>image</code> of the device <code>PTZVideoCamera</code>.
 *
 * <pre>
...
public final class ImageFromPTZVideoCamera implements Serializable {
    ...
    /**
     * Get the sender of the source <code>image</code>. I.e., the <code>PTZVideoCamera</code> device that published the source.
     * 
    ...
    public class PTZVideoCameraProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>image</code> from this <code>PTZVideoCamera</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>image</code> from this <code>PTZVideoCamera</code>.
         */
