...
/**
 * An object to store a value published on the source <code>lastMessage</code> of the device <code>InstantMessenger</code>.
 *
 * <pre>
...
public final class LastMessageFromInstantMessenger implements Serializable {
    ...
    /**
     * Get the sender of the source <code>lastMessage</code>. I.e., the <code>InstantMessenger</code> device that published the source.
     * 
    ...
    public class InstantMessengerProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>lastMessage</code> from this <code>InstantMessenger</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>lastMessage</code> from this <code>InstantMessenger</code>.
         */
