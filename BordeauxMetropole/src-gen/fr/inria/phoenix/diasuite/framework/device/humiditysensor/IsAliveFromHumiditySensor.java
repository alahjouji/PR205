...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>HumiditySensor</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromHumiditySensor implements Serializable {
    ...
    public IsAliveFromHumiditySensor(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromHumiditySensor other = (IsAliveFromHumiditySensor) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>HumiditySensor</code> device that published the source.
     * 
    ...
    public class HumiditySensorProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>HumiditySensor</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>HumiditySensor</code>.
         */
