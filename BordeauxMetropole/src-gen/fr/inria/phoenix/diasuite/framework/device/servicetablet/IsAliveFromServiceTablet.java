...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>ServiceTablet</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromServiceTablet implements Serializable {
    ...
    public IsAliveFromServiceTablet(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromServiceTablet other = (IsAliveFromServiceTablet) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>ServiceTablet</code> device that published the source.
     * 
    ...
    public class ServiceTabletProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>ServiceTablet</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>ServiceTablet</code>.
         */
