...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>TextToSpeech</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromTextToSpeech implements Serializable {
    ...
    public IsAliveFromTextToSpeech(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromTextToSpeech other = (IsAliveFromTextToSpeech) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>TextToSpeech</code> device that published the source.
     * 
    ...
    public class TextToSpeechProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>TextToSpeech</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>TextToSpeech</code>.
         */
