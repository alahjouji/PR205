...
/**
 * An object to store a value published on the source <code>safeContacts</code> of the device <code>Mailer</code>.
 *
 * <pre>
...
public final class SafeContactsFromMailer implements Serializable {
    ...
    /**
     * Get the sender of the source <code>safeContacts</code>. I.e., the <code>Mailer</code> device that published the source.
     * 
    ...
    public class MailerProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>safeContacts</code> from this <code>Mailer</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>safeContacts</code> from this <code>Mailer</code>.
         */
