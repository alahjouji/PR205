...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>RfidIdentifier</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromRfidIdentifier implements Serializable {
    ...
    public IsAliveFromRfidIdentifier(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromRfidIdentifier other = (IsAliveFromRfidIdentifier) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>RfidIdentifier</code> device that published the source.
     * 
    ...
    public class RfidIdentifierProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>RfidIdentifier</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>RfidIdentifier</code>.
         */
