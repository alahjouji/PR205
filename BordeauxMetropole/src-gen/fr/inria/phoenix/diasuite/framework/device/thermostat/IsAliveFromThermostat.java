...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>Thermostat</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromThermostat implements Serializable {
    ...
    public IsAliveFromThermostat(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromThermostat other = (IsAliveFromThermostat) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>Thermostat</code> device that published the source.
     * 
    ...
    public class ThermostatProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>Thermostat</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>Thermostat</code>.
         */
