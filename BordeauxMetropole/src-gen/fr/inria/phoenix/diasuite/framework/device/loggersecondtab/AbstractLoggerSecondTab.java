 ...
 */
public abstract class AbstractLoggerSecondTab extends Service {
    
    public AbstractLoggerSecondTab(ServiceConfiguration serviceConfiguration,
            java.lang.String idValue,
            java.lang.String locationValue,
            java.lang.String userValue) {
        super("/Device/Device/PhysicalDevice/LoggerSecondTab/", serviceConfiguration);
        updateId(idValue);
    ...
    private java.lang.String _logs;
     ...
     */
    protected void publishLogs(java.lang.String newLogsValue) {
        _logs = newLogsValue;
        getProcessor().publishValue(getOutProperties(), "logs", newLogsValue); 
    }
    
    /**
     * Returns the value of source <code>logs</code> from device <code>LoggerSecondTab</code>.
