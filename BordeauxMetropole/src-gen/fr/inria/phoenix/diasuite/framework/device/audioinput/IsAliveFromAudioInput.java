...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>AudioInput</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromAudioInput implements Serializable {
    ...
    public IsAliveFromAudioInput(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromAudioInput other = (IsAliveFromAudioInput) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>AudioInput</code> device that published the source.
     * 
    ...
    public class AudioInputProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>AudioInput</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>AudioInput</code>.
         */
