...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>BluetoothIdentifier</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromBluetoothIdentifier implements Serializable {
    ...
    public IsAliveFromBluetoothIdentifier(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromBluetoothIdentifier other = (IsAliveFromBluetoothIdentifier) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>BluetoothIdentifier</code> device that published the source.
     * 
    ...
    public class BluetoothIdentifierProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>BluetoothIdentifier</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>BluetoothIdentifier</code>.
         */
