...
import fr.inria.phoenix.diasuite.framework.device.networkstorage.AbstractNetworkStorage;
import fr.inria.phoenix.diasuite.framework.device.networkstorage.FileBrowsingIndices;
import fr.inria.phoenix.diasuite.framework.device.networkstorage.FileIndices;

// @internal
public final class NetworkStorageMock {
    ...
    class Proxy extends AbstractNetworkStorage {
    ...
    NetworkStorageMock(ServiceConfiguration serviceConfiguration,
            java.lang.String idValue,
            java.lang.String locationValue,
            java.lang.String userValue,
            java.lang.String nameValue) {
     ...
     */
    public NetworkStorageMock id(java.lang.String newIdValue) {
    ...
    @return this for fluent interface
     */
    public NetworkStorageMock location(java.lang.String newLocationValue) {
    ...
    @return this for fluent interface
     */
    public NetworkStorageMock user(java.lang.String newUserValue) {
    ...
    @return this for fluent interface
     */
    public NetworkStorageMock name(java.lang.String newNameValue) {
    ...
    @return this for fluent interface
     */
    public NetworkStorageMock file(fr.inria.phoenix.diasuite.framework.datatype.file.File newFileValue,
            fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo info) {
    ...
    @return this for fluent interface
     */
    public NetworkStorageMock setFile(fr.inria.phoenix.diasuite.framework.datatype.file.File newFileValue,
            fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo info) {
    ...
    @return this for fluent interface
     */
    public NetworkStorageMock fileBrowsing(java.util.List<fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo> newFileBrowsingValue,
            fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo directory,
            fr.inria.phoenix.diasuite.framework.datatype.filetype.FileType filter) {
    ...
    @return this for fluent interface
     */
    public NetworkStorageMock setFileBrowsing(java.util.List<fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo> newFileBrowsingValue,
            fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo directory,
            fr.inria.phoenix.diasuite.framework.datatype.filetype.FileType filter) {
    ...
    @return this for fluent interface
     */
    public NetworkStorageMock isAlive(java.lang.Boolean newIsAliveValue) {
    ...
    @return this for fluent interface
     */
    public NetworkStorageMock setIsAlive(java.lang.Boolean newIsAliveValue) {
