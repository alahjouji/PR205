...
public final class CookerMock {
    ...
    // Code for source status from device Cooker
    /**
     * Publish the value of source <code>status</code> from device <code>Cooker</code>.
    ...
    @return this for fluent interface
     */
    public CookerMock status(fr.inria.phoenix.diasuite.framework.datatype.state.State newStatusValue) {
    ...
    /**
     * Set the value (without publication) of source <code>status</code> from device <code>Cooker</code>.
    ...
    @return this for fluent interface
     */
    public CookerMock setStatus(fr.inria.phoenix.diasuite.framework.datatype.state.State newStatusValue) {
        __status = newStatusValue;
        return this;
    }
    // End of code for source status from device Cooker
