...
import fr.inria.phoenix.diasuite.framework.device.visualnotifier.AbstractVisualNotifier;

// @internal
public final class VisualNotifierMock {
    ...
    class Proxy extends AbstractVisualNotifier {
        ...
        protected void notify(fr.inria.phoenix.diasuite.framework.datatype.notificationlevel.NotificationLevel level) throws Exception {
    ...
    VisualNotifierMock(ServiceConfiguration serviceConfiguration,
            java.lang.String idValue,
            java.lang.String locationValue,
            java.lang.String userValue) {
     ...
     */
    public VisualNotifierMock id(java.lang.String newIdValue) {
    ...
    @return this for fluent interface
     */
    public VisualNotifierMock location(java.lang.String newLocationValue) {
    ...
    @return this for fluent interface
     */
    public VisualNotifierMock user(java.lang.String newUserValue) {
    ...
    @return this for fluent interface
     */
    public VisualNotifierMock isAlive(java.lang.Boolean newIsAliveValue) {
    ...
    @return this for fluent interface
     */
    public VisualNotifierMock setIsAlive(java.lang.Boolean newIsAliveValue) {
    ...
    /**
     * Check that the <code>notify</code> order from the <code>Notification</code> action
    ...
    public boolean expectNotify() {
        try {
            synchronized(__actions) {
                ...
                if(__action == null)
                    return false;
                if(!("notify".equals(__action.poll())))
                    return false;
                return true;
            }
     ...
     */
    public boolean expectNotify(fr.inria.phoenix.diasuite.framework.datatype.notificationlevel.NotificationLevel level) {
        try {
            synchronized(__actions) {
                java.util.Queue<Object> __action = __actions.poll();
                if(__action == null) {
