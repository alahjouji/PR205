...
public final class LightMock {
    ...
    @return this for fluent interface
     */
    public LightMock status(fr.inria.phoenix.diasuite.framework.datatype.state.State newStatusValue) {
    ...
    @return this for fluent interface
     */
    public LightMock setStatus(fr.inria.phoenix.diasuite.framework.datatype.state.State newStatusValue) {
