...
import fr.inria.phoenix.diasuite.framework.device.mobilestorage.AbstractMobileStorage;
import fr.inria.phoenix.diasuite.framework.device.mobilestorage.FileBrowsingIndices;
import fr.inria.phoenix.diasuite.framework.device.mobilestorage.FileIndices;

// @internal
public final class MobileStorageMock {
    ...
    class Proxy extends AbstractMobileStorage {
    ...
    MobileStorageMock(ServiceConfiguration serviceConfiguration,
            java.lang.String idValue,
            java.lang.String locationValue,
            java.lang.String userValue,
            java.lang.String nameValue) {
     ...
     */
    public MobileStorageMock id(java.lang.String newIdValue) {
    ...
    @return this for fluent interface
     */
    public MobileStorageMock location(java.lang.String newLocationValue) {
    ...
    @return this for fluent interface
     */
    public MobileStorageMock user(java.lang.String newUserValue) {
    ...
    @return this for fluent interface
     */
    public MobileStorageMock name(java.lang.String newNameValue) {
    ...
    @return this for fluent interface
     */
    public MobileStorageMock file(fr.inria.phoenix.diasuite.framework.datatype.file.File newFileValue,
            fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo info) {
    ...
    @return this for fluent interface
     */
    public MobileStorageMock setFile(fr.inria.phoenix.diasuite.framework.datatype.file.File newFileValue,
            fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo info) {
    ...
    @return this for fluent interface
     */
    public MobileStorageMock fileBrowsing(java.util.List<fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo> newFileBrowsingValue,
            fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo directory,
            fr.inria.phoenix.diasuite.framework.datatype.filetype.FileType filter) {
    ...
    @return this for fluent interface
     */
    public MobileStorageMock setFileBrowsing(java.util.List<fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo> newFileBrowsingValue,
            fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo directory,
            fr.inria.phoenix.diasuite.framework.datatype.filetype.FileType filter) {
    ...
    @return this for fluent interface
     */
    public MobileStorageMock isAlive(java.lang.Boolean newIsAliveValue) {
    ...
    @return this for fluent interface
     */
    public MobileStorageMock setIsAlive(java.lang.Boolean newIsAliveValue) {
