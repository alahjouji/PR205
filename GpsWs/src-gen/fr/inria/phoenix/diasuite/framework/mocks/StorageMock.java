...
import fr.inria.phoenix.diasuite.framework.device.storage.FileBrowsingIndices;
import fr.inria.phoenix.diasuite.framework.device.storage.FileIndices;
...
public final class StorageMock {
    ...
    @return this for fluent interface
     */
    public StorageMock location(java.lang.String newLocationValue) {
    ...
    @return this for fluent interface
     */
    public StorageMock user(java.lang.String newUserValue) {
    ...
    @return this for fluent interface
     */
    public StorageMock name(java.lang.String newNameValue) {
    ...
    @return this for fluent interface
     */
    public StorageMock file(fr.inria.phoenix.diasuite.framework.datatype.file.File newFileValue,
            fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo info) {
    ...
    @return this for fluent interface
     */
    public StorageMock setFile(fr.inria.phoenix.diasuite.framework.datatype.file.File newFileValue,
            fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo info) {
    ...
    @return this for fluent interface
     */
    public StorageMock fileBrowsing(java.util.List<fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo> newFileBrowsingValue,
            fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo directory,
            fr.inria.phoenix.diasuite.framework.datatype.filetype.FileType filter) {
    ...
    @return this for fluent interface
     */
    public StorageMock setFileBrowsing(java.util.List<fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo> newFileBrowsingValue,
            fr.inria.phoenix.diasuite.framework.datatype.fileinfo.FileInfo directory,
            fr.inria.phoenix.diasuite.framework.datatype.filetype.FileType filter) {
