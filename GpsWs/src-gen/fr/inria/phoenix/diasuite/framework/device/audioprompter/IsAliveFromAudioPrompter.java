...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>AudioPrompter</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromAudioPrompter implements Serializable {
    ...
    public IsAliveFromAudioPrompter(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromAudioPrompter other = (IsAliveFromAudioPrompter) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>AudioPrompter</code> device that published the source.
     * 
    ...
    public class AudioPrompterProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>AudioPrompter</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>AudioPrompter</code>.
         */
