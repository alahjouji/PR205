...
public abstract class AbstractIdentifier extends Service {
    ...
    public AbstractIdentifier(ServiceConfiguration serviceConfiguration,
     ...
     */
    protected void publishPresent(java.lang.Boolean newPresentValue,
            java.lang.String id) {
        PresentIndices _indices_ = new PresentIndices(id);
        _present.put(_indices_, newPresentValue);
        getProcessor().publishValue(getOutProperties(), "present", newPresentValue, id); 
    }
    
    /**
     * Returns the value of source <code>present</code> from device <code>Identifier</code>.
