...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>WeatherForecaster</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromWeatherForecaster implements Serializable {
    ...
    public IsAliveFromWeatherForecaster(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromWeatherForecaster other = (IsAliveFromWeatherForecaster) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>WeatherForecaster</code> device that published the source.
     * 
    ...
    public class WeatherForecasterProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>WeatherForecaster</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>WeatherForecaster</code>.
         */
