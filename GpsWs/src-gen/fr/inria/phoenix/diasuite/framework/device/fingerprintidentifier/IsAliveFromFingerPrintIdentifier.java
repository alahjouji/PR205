...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>FingerPrintIdentifier</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromFingerPrintIdentifier implements Serializable {
    ...
    public IsAliveFromFingerPrintIdentifier(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromFingerPrintIdentifier other = (IsAliveFromFingerPrintIdentifier) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>FingerPrintIdentifier</code> device that published the source.
     * 
    ...
    public class FingerPrintIdentifierProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>FingerPrintIdentifier</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>FingerPrintIdentifier</code>.
         */
