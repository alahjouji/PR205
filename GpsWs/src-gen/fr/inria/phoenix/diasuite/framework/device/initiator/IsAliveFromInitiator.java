...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>Initiator</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromInitiator implements Serializable {
    ...
    public IsAliveFromInitiator(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromInitiator other = (IsAliveFromInitiator) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>Initiator</code> device that published the source.
     * 
    ...
    public class InitiatorProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>Initiator</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>Initiator</code>.
         */
