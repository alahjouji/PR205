...
/**
 * An object to store a value published on the source <code>currentChannel</code> of the device <code>Tv</code>.
 *
 * <pre>
...
public final class CurrentChannelFromTv implements Serializable {
    ...
    /**
     * Get the sender of the source <code>currentChannel</code>. I.e., the <code>Tv</code> device that published the source.
     * 
    ...
    public class TvProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>currentChannel</code> from this <code>Tv</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>currentChannel</code> from this <code>Tv</code>.
         */
