...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>Shutter</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromShutter implements Serializable {
    ...
    public IsAliveFromShutter(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromShutter other = (IsAliveFromShutter) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>Shutter</code> device that published the source.
     * 
    ...
    public class ShutterProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>Shutter</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>Shutter</code>.
         */
