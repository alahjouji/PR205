...
/**
 * An object to store a value published on the source <code>trustedQuestionAnswer</code> of the device <code>SMSSender</code>.
 *
 * <pre>
...
public final class TrustedQuestionAnswerFromSMSSender implements Serializable {
    ...
    public TrustedQuestionAnswerFromSMSSender(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.String value,
    ...
    /**
     * Get the sender of the source <code>trustedQuestionAnswer</code>. I.e., the <code>SMSSender</code> device that published the source.
     * 
    ...
    public class SMSSenderProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>trustedQuestionAnswer</code> from this <code>SMSSender</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>trustedQuestionAnswer</code> from this <code>SMSSender</code>.
         */
