...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>Battery</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromBattery implements Serializable {
    ...
    public IsAliveFromBattery(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromBattery other = (IsAliveFromBattery) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>Battery</code> device that published the source.
     * 
    ...
    public class BatteryProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>Battery</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>Battery</code>.
         */
