...
public abstract class AbstractDoorLocker extends Service {
    ...
    public AbstractDoorLocker(ServiceConfiguration serviceConfiguration,
    ...
    /**
     * Returns the value of source <code>locked</code> from device <code>DoorLocker</code>.
    ...
    /**
     * Implement this method to define the <code>lock</code> order from the <code>Lock</code> action
     * defined in device DoorLocker.
     * 
    ...
    /**
     * Implement this method to define the <code>unlock</code> order from the <code>UnLock</code> action
     * defined in device DoorLocker.
     * 
