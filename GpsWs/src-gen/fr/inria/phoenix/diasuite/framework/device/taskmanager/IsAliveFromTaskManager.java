...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>TaskManager</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromTaskManager implements Serializable {
    ...
    public IsAliveFromTaskManager(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromTaskManager other = (IsAliveFromTaskManager) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>TaskManager</code> device that published the source.
     * 
    ...
    public class TaskManagerProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>TaskManager</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>TaskManager</code>.
         */
