...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>SmokeSensor</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromSmokeSensor implements Serializable {
    ...
    public IsAliveFromSmokeSensor(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromSmokeSensor other = (IsAliveFromSmokeSensor) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>SmokeSensor</code> device that published the source.
     * 
    ...
    public class SmokeSensorProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>SmokeSensor</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>SmokeSensor</code>.
         */
