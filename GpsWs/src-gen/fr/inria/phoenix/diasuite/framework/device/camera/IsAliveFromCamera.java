...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>Camera</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromCamera implements Serializable {
    ...
    public IsAliveFromCamera(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromCamera other = (IsAliveFromCamera) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>Camera</code> device that published the source.
     * 
    ...
    public class CameraProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>Camera</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>Camera</code>.
         */
