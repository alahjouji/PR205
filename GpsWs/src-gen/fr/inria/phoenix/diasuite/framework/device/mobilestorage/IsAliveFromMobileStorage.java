...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>MobileStorage</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromMobileStorage implements Serializable {
    ...
    public IsAliveFromMobileStorage(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromMobileStorage other = (IsAliveFromMobileStorage) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>MobileStorage</code> device that published the source.
     * 
    ...
    public class MobileStorageProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>MobileStorage</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>MobileStorage</code>.
         */
