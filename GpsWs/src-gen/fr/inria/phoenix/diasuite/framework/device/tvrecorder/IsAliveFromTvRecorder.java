...
/**
 * An object to store a value published on the source <code>isAlive</code> of the device <code>TvRecorder</code>.
 *
 * <pre>
 ...
 * </pre>
 */
public final class IsAliveFromTvRecorder implements Serializable {
    ...
    public IsAliveFromTvRecorder(Service service, RemoteServiceInfo remoteServiceInfo, java.lang.Boolean value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        IsAliveFromTvRecorder other = (IsAliveFromTvRecorder) obj;
        if (value == null) {
            if (other.value != null)
                return false;
    ...
    /**
     * Get the sender of the source <code>isAlive</code>. I.e., the <code>TvRecorder</code> device that published the source.
     * 
    ...
    public class TvRecorderProxy extends Proxy {
        ...
        /**
         * Subcribes to publication of source <code>isAlive</code> from this <code>TvRecorder</code>.
         */
        ...
        /**
         * Unsubcribes from publication of source <code>isAlive</code> from this <code>TvRecorder</code>.
         */
